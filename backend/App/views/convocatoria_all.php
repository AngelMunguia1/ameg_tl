													...
													<div class="container">
														<div class="col">
															<div class="row" style="width: 80%; margin: 0px auto;">
																<div class="icon-box-info text-center ameg-shadow-box-btn-uno">
																	<img src="/img/trofeo.png" width="30" height="30" alt="" />
																		&nbsp;&nbsp; Primer lugar &nbsp;&nbsp;
																</div>
																<div class="icon-box-info text-center ameg-shadow-box-btn-dos">
																	<img src="/img/trofeo.png" width="30" height="30" alt="" />
																		&nbsp;&nbsp; Segundo lugar &nbsp;
																</div>
																<div class="icon-box-info text-center ameg-shadow-box-btn-tres">
																	<img src="/img/trofeo.png" width="30" height="30" alt="" />
																		&nbsp;&nbsp; Tercer lugar  &nbsp;&nbsp;&nbsp;
																</div>
															</div>
