...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/Encargado/">Encargados</a></li>
    ...
    <div class="container-fluid col-md-8 card" id="basic-info">
        <form class="form-horizontal" id="add" action="/Encargado/responsableAdd" method="POST">
            <div class="form-group ">
                <div class="card-header">
                    <h5>Datos Generales para Agregar al Encargado</h5>
                </div>
