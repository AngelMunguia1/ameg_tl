...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/Cuenta/">Cuentas</a></li>
    ...
    <div class="container-fluid col-md-8 card" id="basic-info">
        <form class="form-horizontal" id="add" action="/Cuenta/cuentaAdd" method="POST">
            <div class="form-group ">
                <div class="card-header">
                    <h5>Datos Generales para Agregar a la Cuenta</h5>
                </div>
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <div class="input-group">
                                <select id="nombre" name="nombre" class="form-control" type="text" default="Grupo LAHE S.A. de C.V." required="required" onfocus="focused(this)" onfocusout="defocused(this)">
